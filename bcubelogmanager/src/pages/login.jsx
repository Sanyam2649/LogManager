...
import { adminLogin } from "../service/adminAuth";
...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      login(data.project, data.access_token);
      navigate("/dashboard");
    } catch (err) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        {/* Card */}
        <div
          className="card w-full bg-base-100/80 backdrop-blur 
